...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2022 at 04:17 AM
...
CREATE TABLE `direccion` (
  `id_direccion` int(11) NOT NULL,
  `calle-carrera` varchar(10) COLLATE utf8_spanish_ci NOT NULL DEFAULT '0',
...
INSERT INTO `direccion` (`id_direccion`, `calle-carrera`, `numero`, `barrio`, `ciudad`) VALUES
